...
:mod:`souplite.mcp_server.registry` (no SDK dependency, fully unit-testable).
...
from souplite.mcp_server.registry import McpToolError, ToolSpec, _sanitize, build_registry
