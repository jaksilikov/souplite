...
from souplite.cans.unpack import extract_can, inspect_can, read_config
...
def run_can(
    ...
    train_argv = [
        sys.executable, "-m", "souplite.cli", "train",
