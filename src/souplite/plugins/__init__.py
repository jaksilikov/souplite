...
Bundled modules and third-party ``souplite.plugins`` entry points are discovered
...
_ENTRY_POINT_GROUP = "souplite.plugins"
...
def load_plugins() -> int:
    """Discover built-in modules and ``souplite.plugins`` entry points once.
