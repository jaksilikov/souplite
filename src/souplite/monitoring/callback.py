...
class _SoupTrainerCallback_body:  # noqa: N801
    ...
    def on_step_end(
        ...
        try:
            from souplite.utils.tool_outputs import get_global_tool_buffer
    ...
    def on_log(
        ...
        try:
            from souplite.utils.sse_train_stream import TrainEvent
            from souplite.utils.train_event_buffer import push_train_event
    ...
    def _run_eval_gate(self, state: TrainerState, control: TrainerControl) -> None:
        ...
        from souplite.eval.gate import run_gate as _default_run_gate
    ...
    def _run_auto_eval(self) -> None:
        ...
        if benchmarks:
            try:
                from souplite.commands.eval import benchmark
                benchmark(
        ...
        if custom_tasks:
            try:
                from souplite.commands.eval import custom
