...
def make_grpo_trainer_variant(base_cls: type, variant: str) -> type:
    ...
    through :func:`souplite.utils.grpo_variants.apply_variant_loss`. Cached
    ...
    MEDIUM fix).
    """
    from souplite.utils.grpo_variants import validate_grpo_variant
...
def _make_grpo_trainer_variant_cached(base_cls: type, variant: str) -> type:
    ...
    from souplite.utils.grpo_variants import apply_variant_loss
...
def _select_reward_fn(
    ...
    if tcfg.prm_reward is not None:
        from souplite.utils.prm_reward import build_prm_reward_fn
    ...
    from souplite.trainer.rewards import load_reward_fns
...
class GRPOTrainerWrapper:
    ...
    def setup(self, dataset: dict):
        ...
        from souplite.trainer.sft import _enable_hf_transfer_progress
        ...
        if rl_callbacks_need_buffer(tcfg):
            ...
            from souplite.utils.rl_signal_buffer import (
                RLSignalBuffer,
                wrap_reward_funcs,
            )
        ...
        from souplite.trainer.rewards import validate_reward_funcs
        ...
        from souplite.utils.peft_wiring import attach_grpo_stability_callback
    ...
    def train(
        ...
        from souplite.utils.v028_features import activation_offloading_context
