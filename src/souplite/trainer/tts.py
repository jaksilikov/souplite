...
:class:`~souplite.trainer.sft.SFTTrainerWrapper` for model/tokenizer/LoRA/CE
...
Security / robustness:
- Family validated via :func:`souplite.utils.tts.validate_tts_family` before
  any model load.
...
from souplite.trainer.sft import SFTTrainerWrapper, console
