...
optimises the per-method loss from :mod:`souplite.utils.unlearn_kernels`.
...
class UnlearnTrainerWrapper:
    ...
    def train(self, **kwargs: Any) -> dict:
        ...
        from souplite.utils.live_eval import _tokenize_pair
    ...
    def _step_preference(self, tokenize_pair, prompt, target, method, dev):
        ...
        from souplite.utils.unlearn_kernels import (
            npo_loss,
            sequence_lengths,
            sequence_logprob,
            simnpo_loss,
