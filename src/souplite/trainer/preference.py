...
class PreferenceTrainerWrapper:
    ...
    def _build_multi_objective(self):
        ...
        The math kernel ships in :mod:`souplite.utils.preference_combine`
        ...
        if primary == "dpo":
            from souplite.trainer.dpo import DPOTrainerWrapper as PrimaryWrapper
        elif primary == "simpo":
            from souplite.trainer.simpo import SimPOTrainerWrapper as PrimaryWrapper
        elif primary == "orpo":
            from souplite.trainer.orpo import ORPOTrainerWrapper as PrimaryWrapper
        elif primary == "ipo":
            from souplite.trainer.ipo import IPOTrainerWrapper as PrimaryWrapper
        elif primary == "bco":
            from souplite.trainer.bco import BCOTrainerWrapper as PrimaryWrapper
    ...
    def setup(self, dataset: dict) -> None:
        ...
        if is_multi_objective_preference(self.config):
            ...
            from souplite.utils.preference_combine import validate_weight_compat
