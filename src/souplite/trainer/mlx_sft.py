...
class _MlxRewind:
    ...
    def wrap(self, train_dataset: object) -> object:
        ...
        from souplite.trainer.rewind_mlx import wrap_dataset
...
def _start_rewind(
    *,
    ...
    try:
        ...
        from souplite.trainer.rewind_mlx import MlxRewindState, make_rewind_loss
...
class MLXSFTTrainerWrapper:
    ...
    def _require_mlx(self) -> None:
        try:
            ...
            raise ImportError(
                ...
                "Install with: pip install \"souplite[mlx]\""
            ) from exc
    ...
    def setup(self, dataset: dict) -> None:
        ...
        from souplite.utils.mlx import load_mlx_model
    ...
    def train(self, display=None, tracker=None, run_id=None, resume_from_checkpoint=None) -> dict:
        ...
        if use_token_mask:
            from souplite.trainer.mlx_masking import (
                MaskedChatDataset,
                ResponseMaskError,
        ...
        from souplite.trainer.mlx_optim import build_optimizer, plan_optimizer
