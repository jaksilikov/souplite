...
class DPOTrainerWrapper(StreamingSetupMixin):
    ...
    def setup(self, dataset: dict):
        ...
        from souplite.trainer._trl_compat import (
            config_accepts,
        ...
        if tcfg.stream_layers:
            ...
            from souplite.utils.layer_stream_runtime import materialize_meta_adapter_copy
    ...
    def train(
        ...
        from souplite.utils.dpo_variants import build_dpo_variant_callbacks
