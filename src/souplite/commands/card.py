...
from souplite.commands.push import (
...
def build_model_card(
    ...
    fm.append("tags:")
    for tag in ("souplite", "fine-tuned", "compliance"):
        fm.append(f"  - {tag}")
    fm.append("---")

    lines: list[str] = list(fm)
    lines += ["", f"# {_safe_md_cell(name)}", ""]
    lines.append("Fine-tuned with [SoupLite](https://github.com/MuhtarJaksilikov/Soup).")
    lines.append("")
