...
def _run_kind_probe_cli(
    ...
    *,
    ...
    from souplite.utils.probe_kernel import ProbeResult, load_probe_weights
...
def truth(
    ...
    from souplite.utils.truth_probe import (
...
def harm(
    ...
    from souplite.utils.harm_probe import (
        BUNDLED_HARM_PROBES,
        render_harm_json,
...
def _emit_matrix(matrix: Any, output: Optional[str]) -> None:
    ...
    from souplite.utils.interference import render_matrix_json, render_matrix_markdown
