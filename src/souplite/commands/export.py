...
def _find_llama_cpp(user_path: Optional[str] = None) -> Path:
    ...
    """
    from souplite.utils.constants import SOUP_DIR
...
def _export_onnx(
    ...
    try:
        ...
        console.print(
            ...
            "Install with: [bold]pip install \"souplite\\[onnx]\"[/]\n"
...
def _export_tensorrt(
    ...
    if not trtllm_available:
        console.print(
            ...
            "Install with: [bold]pip install \"souplite\\[tensorrt]\"[/]\n"
...
def _export_awq(
    ...
    try:
        ...
        console.print(
            ...
            "Install with: [bold]pip install \"souplite\\[awq]\"[/]\n"
...
def _export_gptq(
    ...
    try:
        ...
        console.print(
            ...
            "Install with: [bold]pip install \"souplite\\[gptq]\"[/]\n"
...
def _auto_deploy_ollama(
    ...
    from souplite.commands.deploy import _auto_detect_template
...
def _maybe_attach_export(
    *, artifact_path: str, kind: str,
    ...
    succeeded).
    """
    from souplite.registry.attach import attach_artifact, lookup_entry_by_output_dir
...
def _export_bitnet_gguf(
    *,
    ...
    llama.cpp toolchain.
    """
    from souplite.utils.bitnet import export_bitnet_gguf, validate_bitnet_export
    ...
    *,
    ...
    if not is_advanced_gguf_format(gguf_flavour):
        console.print(
            ...
            "See souplite.utils.gguf_quant.ALL_ADVANCED_GGUF_FORMATS.[/]"
        )
        raise typer.Exit(2)
