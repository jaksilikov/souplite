...
from souplite.utils.canary_router import CanaryPolicy
from souplite.utils.loop_budget import parse_budget_string
...
def replay_cmd(
    ...
    if extract is not None:
        from souplite.cans.unpack import extract_can
