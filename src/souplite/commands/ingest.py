...
from souplite.commands._webhook_cli import emit_webhooks, validate_webhook_flags
from souplite.utils import ingest_sources as _ingest_sources
from souplite.utils.ingest_sources import (
...
def _pull(
    ...
    *,
    ...
    from souplite.utils.paths import atomic_write_lines, enforce_under_cwd_and_no_symlink
