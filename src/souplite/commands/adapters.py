...
def diff(
    ...
    from souplite.utils.adapter_diff import (
...
def merge(
    ...
    from souplite.utils.adapter_merge import SUPPORTED_STRATEGIES, merge_adapters
    from souplite.utils.license_matrix import (
    ...
    if not allow_unscanned:
        from souplite.utils.adapter_scan import scan_adapter
...
def arithmetic(
    ...
    from souplite.utils.adapter_arithmetic import (
        ArithmeticReport,
        _detect_lora_rank,
    ...
    from souplite.utils.adapter_diff import load_adapter_weights
    from souplite.utils.adapter_merge import write_merged_adapter
    from souplite.utils.paths import enforce_under_cwd_and_no_symlink
...
def checkout(
    ...
    from souplite.utils.adapter_branch import load_branch, write_checkout
...
def list_branches_cmd():
    ...
    from souplite.utils.adapter_branch import list_branches, load_branch
...
def scan(
    ...
    """
    from souplite.utils.adapter_scan import render_report_text, scan_adapter
...
def check_safetensors(
    ...
    """
    from souplite.utils.strict_safetensors import check_strict_safetensors
...
def adapter_pr(
    ...
    push: Optional[str] = typer.Option(
        ...
        help=(
            ...
            "owner/repo#N (e.g. MuhtarJaksilikov/Soup#42). Auth via "
    ...
    """
    from souplite.utils.adapter_pr import (
        build_adapter_pr,
        post_pr_comment,
        render_pr_json,
        render_pr_markdown,
...
def adapter_bisect(
    ...
    """
    from souplite.utils.adapter_bisect import build_bisect_plan, run_bisect
...
def audit(
    ...
    from souplite.utils.adapter_audit import audit_adapter, unknown_reason
