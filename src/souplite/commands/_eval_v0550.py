...
def register(app: typer.Typer, console: Console) -> None:
    ...
    def design_cmd(
        ...
        from souplite.utils.advise import load_advise_dataset
        from souplite.utils.eval_design import (
    ...
    def discover_cmd(
        ...
        from souplite.utils.advise import load_advise_dataset
        from souplite.utils.canary_discovery import (
            discover_canaries,
            write_canary_set,
        )
    ...
    def lock_cmd(
        ...
        from souplite.utils.eval_design import load_eval_design
        from souplite.utils.eval_lock_coverage import lock_suite
    ...
    def coverage_cmd(
        ...
        from souplite.utils.eval_design import load_eval_design
        from souplite.utils.eval_lock_coverage import compute_coverage
    ...
    def against_cmd(
        ...
        suite: str = typer.Option(
            ...
            help=(
                ...
                "(exit 3). cwd-contained. The generated pre-push hook passes "
        ...
        ``0`` when no regression is detected, ``2`` on regression, and ``3``
        on bad flag, missing suite or missing run data. Designed
        to be invoked from the pre-push hook generated by
        ``soup eval gate-install``.
        """
        import json as _json

        from souplite.utils.eval_gate_hook import (
            GateThresholds,
            decide_regression,
            resolve_gate_metric,
        )
        ...
        # passed the gate.
        if suite:
            from souplite.utils.eval_lock_coverage import load_locked_suite
        ...
        raise typer.Exit(EXIT_GATE_FAILED if verdict.regressed else EXIT_OK)
    ...
    def gate_install_cmd(
        ...
        from souplite.utils.eval_gate_hook import write_pre_push_hook
