...
from souplite.utils._eval_text import row_text
...
from souplite.utils.topics import build_topic_report, kmeans, resolve_k

console = Console()


def _report_to_dict(report) -> dict:
    """JSON-safe rendering of a :class:`~souplite.utils.topics.TopicReport`."""
    return {
