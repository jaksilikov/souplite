...
def push(
    ...
    commit_message: str = typer.Option(
        "Upload model trained with SoupLite",
        "--message",
    ...
    from souplite.utils.hf import resolve_endpoint, resolve_token, validate_repo_id
    ...
    if hub_canonical != "hf":
        ...
        from souplite.utils.hubs import hub_token_env_var, resolve_hub_token
    ...
    try:
        ...
        if card_override is not None:
            ...
            api.upload_file(
                ...
                path_in_repo="README.md",
                repo_id=repo,
                commit_message="Add model card (generated by SoupLite)",
            )
...
def generate_model_card_v2(
    ...
    sections = [
        ...
        f"# {model_name}",
        "",
        "Fine-tuned model uploaded with [SoupLite](https://github.com/MuhtarJaksilikov/Soup).",
        "",
        "## Model Details",
        "",
        details_block,
    ...
    if not training_section:
        tail.extend(
            [
                "## Training",
                "",
                "Trained using [SoupLite]"
                "(https://github.com/MuhtarJaksilikov/Soup) "
