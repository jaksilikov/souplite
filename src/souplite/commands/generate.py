...
def _run_dedup_pipeline(path: Path) -> None:
    ...
    try:
        ...
        console.print(
            ...
            "Install: pip install \"souplite\\[data]\"[/]"
        )
...
def _generate_batch(
    ...
    if provider == "openai":
        ...
        from souplite.data.providers.ollama import DEFAULT_OLLAMA_BASE, generate_ollama
        ...
        from souplite.data.providers.vllm import DEFAULT_VLLM_BASE, generate_vllm
...
def _generate_local(
    ...
    from souplite.utils.vllm import encode_rendered_prompt
...
def _parse_json_array(content: str) -> list[dict]:
    ...
    Delegates to souplite.data.providers._utils.parse_json_array to avoid
