...
from souplite.utils.layer_shard import QUANT_NONE, SUPPORTED_STREAM_QUANTS
...
from souplite.utils.async_disk_source import (  # noqa: E402
...
def resolve_stream_dtype(device: str = "cuda") -> str:
    ...
    if device_name.startswith("mps"):
        from souplite.utils.gpu import mps_supports_bf16
