...
from souplite.utils.net_guard import is_private_or_link_local as _is_private_or_link_local
...
def resolve_hub_token(hub: str, explicit: str | None = None) -> str | None:
    ...
    :func:`souplite.utils.hf.resolve_token`.
    """
    canonical = validate_hub_name(hub)
    if canonical == "hf":
        raise ValueError("use souplite.utils.hf.resolve_token for the hf hub")
