...
a subprocess via ``subprocess.Popen([sys.executable, "-m", "souplite.cli",
...
from souplite.utils.canary_router import BucketStats, CanaryPolicy, rollback
...
from souplite.utils.loop_state import LoopState, read_state, write_state
...
def default_harvest(state: LoopState) -> Mapping[str, object]:
    ...
    Real implementation wires v0.26.0 ``souplite.data.traces.parsers`` +
