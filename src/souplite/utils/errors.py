...
_TRAIN_FIX = "Training needs the \\[train] extra. Run: pip install \"souplite\\[train]\""
...
ERROR_MAP = [
    ...
    (
        ...
        "Run: pip install \"souplite\\[serve]\"",
    ),
    (
    ...
    (
        ...
        "Run: pip install \"souplite\\[deepspeed]\"",
    ),
    (
        "No module named 'httpx'",
        "httpx is not installed (needed for data generate).",
        "Run: pip install \"souplite\\[generate]\"",
    ),
