...
:mod:`souplite.utils.live_eval`; importing this module is cheap.
...
from souplite.utils.diagnose.runner import build_report, neutral_score
from souplite.utils.live_eval import token_f1
from souplite.utils.paths import enforce_under_cwd_and_no_symlink

if TYPE_CHECKING:
    from souplite.utils.diagnose.report import FailureReport
...
def run_live_diagnose(
    ...
    * **contamination** — pure data overlap (no model; empty benchmark corpus
    ...
    from souplite.utils.diagnose.format import score_format
    from souplite.utils.diagnose.memorization import score_memorization
    from souplite.utils.diagnose.mode_collapse import score_mode_collapse
    from souplite.utils.diagnose.refusal import score_refusal
    ...
    if rows:
        from souplite.utils.diagnose.citation import is_raft_row, score_citation
