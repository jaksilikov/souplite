...
def get_or_create_distinct_id() -> str:
    ...
    from souplite.utils.constants import SOUP_DIR  # noqa: PLC0415
...
# v0.53.10 #154 — bundled public write-only project key for SoupLite
...
def _telemetry_endpoint_is_safe(endpoint: str) -> bool:
    ...
    try:
        from souplite.utils.hubs import validate_hub_endpoint
    ...
    from souplite.utils.hubs import (  # noqa: PLC0415
        _LOOPBACK_HOSTS,
...
def tracker_missing_dep_message(name: str) -> str | None:
    ...
    if missing:
        return (
            ...
            f"Install with: pip install souplite[trackers] "
