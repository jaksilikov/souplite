...
from souplite.utils.data_doctor import VERDICTS, sample_indices
...
def check_near_duplicates(
    ...
    try:
        ...
        return LintCheck(
            ...
            evidence="pip install \"souplite[data]\" to enable",
        )
    if len(rows) < 2:
        return LintCheck(
...
def run_lint(
    ...
    *,
    ...
    from souplite.data.formats import detect_format, format_to_messages
