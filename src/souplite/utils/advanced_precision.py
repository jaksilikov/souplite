...
def apply_fp8_attention(model: object, *, recipe: str = "tensorwise") -> int:
    ...
    from souplite.utils import fp8
...
def apply_nvfp4(model: object) -> int:
    ...
    ``souplite/utils/torchao_compat.py`` holds both, and where each lives.
    ...
    from souplite.utils.torchao_compat import resolve_torchao_class
