...
class OQExternalTensorSpec:
    ...
    def __post_init__(self) -> None:
        from souplite.utils.oq_affine import AffineQuantSpec, logical_width
...
def estimate_oq_stream_cache_bytes(
    ...
    from souplite.utils.oq_affine import load_affine_quant_config, logical_width
...
def shard_checkpoint(
    ...
    *,
    ...
    oq_config = None
    if saw_oq_companion:
        from souplite.utils.oq_affine import load_affine_quant_config
    ...
    for logical_key, indexed_keys in oq_external_keys.items():
        ...
        for _part_index, weight_key in indexed_keys:
            ...
            with safe_open(path, framework="pt") as handle:
                ...
                from souplite.utils.oq_affine import logical_width
...
def _read_oq_tensor(
    ...
    *,
    ...
    from souplite.utils.oq_affine import dequantize_affine
