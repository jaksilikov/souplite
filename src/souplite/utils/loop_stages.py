...
from souplite.utils.net_guard import LOOPBACK_HOSTS as _LOOPBACK_HOSTS
from souplite.utils.net_guard import parse_ip_literal
...
def harvest_from_traces(state: LoopState) -> Mapping[str, object]:
    ...
    """
    from souplite.data.traces.pair_builder import build_pairs
...
def gate_against_baseline(
    ...
    from souplite.eval.gate import load_suite, resolve_baseline, run_gate
...
def deploy_to_canary(
    ...
    from souplite.utils.drift_alarm import validate_webhook_url
...
def estimate_cost(state: LoopState) -> float:
    ...
    try:
        ...
        from souplite.utils.run_cost import estimate_run_cost_usd
