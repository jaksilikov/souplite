...
Wraps v0.26.0 :mod:`souplite.eval.quant_check` with disk-cache so that
...
def compute_cache_key(
    *,
    ...
    digest inputs. The orchestrator in :mod:`souplite.commands.deploy`
...
def _score_tasks(
    ...
    from souplite.eval.custom import load_eval_tasks, score_task
...
def build_before_generator(
    ...
    *,
    ...
    :func:`souplite.utils.live_eval.make_generator`) on the first prompt —
