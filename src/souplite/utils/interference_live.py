...
The v0.66.0 :mod:`souplite.utils.interference` matrix builder consumes a dict of
...
and in :mod:`souplite.utils.live_eval`; importing this module is cheap.
...
from souplite.utils.interference import _MAX_ADAPTERS, _MIN_ADAPTERS
...
def measure_interference_losses(
    ...
    *,
    ...
    :func:`souplite.utils.interference.build_interference_matrix`.
    """
