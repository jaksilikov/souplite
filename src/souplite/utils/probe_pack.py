...
- Part C (``souplite.utils.sleeper_probe``) — the live sleeper probe
- Part A (``souplite.utils.sae_diff``) — the SAE feature-diff surface
- Part D (``souplite.utils.interference``) — adapter pairwise eval
...
def _make_bundled_packs() -> Mapping[str, ProbePack]:
    ...
    from souplite.utils.harm_probe import BUNDLED_HARM_PROBES
    from souplite.utils.sleeper_probe import BUNDLED_PROBES
    from souplite.utils.truth_probe import BUNDLED_TRUTH_PROBES
