...
> Status: design-and-contract slice for [issue #580](https://github.com/MuhtarJaksilikov/Soup/issues/580).
...
The implementation is in `souplite.autodistill.contract`. Pydantic models are frozen
