...
FP32 intermediates cost time and memory. The [maintainer's PR #736 measurement](https://github.com/MuhtarJaksilikov/Soup/pull/736)
...
training:
  ...
  rollout_func: souplite.envs.calculator:rollout   # or retrieval_qa / guess_number
