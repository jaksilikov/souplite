...
- Part A: ``souplite.plugins`` registry + ``soup plugins`` CLI
...
from souplite.utils.integrations import (
    get_integration,
    has_integration,
    list_integrations,
)
from souplite.utils.ngram_spec import (
    NgramSpecConfig,
...
from souplite.utils.recipe_dag import (
    NODE_KINDS,
    load_recipe_yaml,
    parse_recipe,
    parse_recipe_yaml,
...
from souplite.utils.trainer_plugins import (
    get_trainer_plugin,
...
def test_plugins_cli_list_empty():
    from souplite.commands import plugins as plugins_cli
