...
class TestLicenseMatrix:
    ...
    def test_known_licenses_includes_common(self):
        from souplite.utils.license_matrix import KNOWN_LICENSES
    ...
    def test_matrix_immutable(self):
        from souplite.utils.license_matrix import LICENSE_MATRIX

        with pytest.raises(TypeError):
            LICENSE_MATRIX["evil"] = ("anything",)  # type: ignore[index]

    def test_normalise_license_id(self):
        from souplite.utils.license_matrix import normalise_license_id
...
class TestSourceWiring:
    def test_module_imports(self):
        from souplite.utils import license_matrix as m
