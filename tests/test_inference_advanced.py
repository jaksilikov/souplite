...
class TestPrefixCachingEngine:
    def test_create_engine_accepts_prefix_cache(self):
        from souplite.utils.vllm import create_vllm_engine
    ...
    def test_create_engine_passes_prefix_cache_to_vllm(self):
        ...
        with patch.dict("sys.modules", {
            ...
            import souplite.utils.vllm as vllm_mod
...
class TestStructuredOutput:
    ...
    def test_validate_json_schema_accepts_dict(self):
        from souplite.utils.structured_output import validate_json_schema
    ...
    def test_validate_regex_pattern_rejects_redos(self):
        ...
        from souplite.utils.structured_output import validate_regex_pattern
...
class TestRequestTracing:
    ...
    def test_is_otel_available_when_missing(self):
        from souplite.utils.tracing import is_otel_available
    ...
    def test_build_tracer_returns_none_when_otel_missing(self):
        ...
        with patch(
            "souplite.utils.tracing.is_otel_available", return_value=False
        ):
...
class TestAutoQuant:
    ...
    def test_candidate_order_default(self):
        from souplite.utils.auto_quant import default_candidate_order
    ...
    def test_pick_best_candidate_prefers_fastest_ok(self):
        from souplite.utils.auto_quant import Candidate, pick_best
    ...
    def test_pick_best_empty_list(self):
        from souplite.utils.auto_quant import pick_best
