...
def test_module_imports():
    from souplite.utils import probe_pack
...
def test_probe_kinds_frozen():
    from souplite.utils.probe_pack import PROBE_KINDS
...
def test_list_probe_bases_sorted():
    from souplite.utils.probe_pack import BUNDLED_PACKS, list_probe_bases
...
def test_validate_pack_base_happy():
    from souplite.utils.probe_pack import BUNDLED_PACKS, validate_pack_base
...
def test_validate_pack_base_unknown_raises():
    from souplite.utils.probe_pack import validate_pack_base
...
def test_probe_pack_rejects_empty_probes():
    from souplite.utils.probe_pack import ProbePack
...
def test_get_probe_pack_happy():
    from souplite.utils.probe_pack import BUNDLED_PACKS, ProbePack, get_probe_pack
...
def test_get_probe_pack_unknown_raises():
    from souplite.utils.probe_pack import get_probe_pack
...
def test_get_probe_pack_case_insensitive():
    from souplite.utils.probe_pack import BUNDLED_PACKS, get_probe_pack
...
def test_render_pack_json_rejects_non_pack():
    from souplite.utils.probe_pack import render_pack_json
...
def test_render_pack_markdown_rejects_non_pack():
    from souplite.utils.probe_pack import render_pack_markdown
