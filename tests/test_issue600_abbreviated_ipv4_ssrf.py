...
class TestHubsPrivateOrLinkLocalAbbreviated:
    ...
    def test_rejects_private_ip(self, host: str) -> None:
        from souplite.utils.hubs import _is_private_or_link_local
...
class TestHfPrivateOrLinkLocalAbbreviated:
    ...
    def test_rejects_private_ip(self, host: str) -> None:
        from souplite.utils.hf import _is_private_or_link_local
...
class TestWebhooksPrivateOrLinkLocalAbbreviated:
    ...
    def test_rejects_private_ip(self, host: str) -> None:
        from souplite.utils.webhooks import _is_private_or_link_local
...
# a duplicate. #616 folded it into the shared souplite.utils.net_guard
...
class TestTracingPrivateOrLinkLocalAbbreviated:
    ...
    def test_rejects_private_ip(self, host: str) -> None:
        from souplite.utils.tracing import _is_private_ip
...
class TestTelemetrySSRFEndToEndPinning:
    ...
    def test_telemetry_endpoint_is_safe_rejects_abbreviated_forms(
        ...
        from souplite.utils.trackers import _telemetry_endpoint_is_safe
