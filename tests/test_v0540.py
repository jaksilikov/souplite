...
from souplite.commands import advise as advise_cmd
from souplite.utils.advise import (
    CHOICES,
    TASK_CATEGORIES,
    DatasetProfile,
    ROIEstimate,
...
from souplite.utils.advise_history import (
    HistoryEntry,
    history_path,
    load_history,
    record_verdict,
...
class TestHistoryPath:
    ...
    def test_env_null_byte_falls_back(self, monkeypatch):
        ...
        from souplite.utils import advise_history
...
class TestSourceWiring:
    def test_cli_registers_advise(self):
        cli_path = Path(__file__).resolve().parent.parent / "src" / "souplite" / "cli.py"
    ...
    def test_advise_module_imports(self):
        ...
        from souplite.commands import advise as _cmd  # noqa: F401
        from souplite.utils import advise as _advise  # noqa: F401
        from souplite.utils import advise_history as _hist  # noqa: F401


class TestArgvRewriter:
    def test_no_advise_in_argv(self):
        from souplite.cli import _rewrite_advise_argv
...
"""
    ...
    def test_advise_null_byte_goal_rejected(self):
        ...
        from souplite.config.schema import AdviseConfig
