...
class TestManifest:
    def test_imports(self):
        from souplite.utils.adapter_sign import (
            AdapterManifest,
            SignatureRecord,
    ...
    def test_manifest_deterministic(self, tmp_path, monkeypatch):
        ...
        from souplite.utils.adapter_sign import compute_adapter_manifest
...
class TestSourceWiring:
    def test_module_imports_clean(self):
        import souplite.utils.adapter_sign as m
    ...
    def test_signature_filename_constant(self):
        from souplite.utils.adapter_sign import _SIGNATURE_FILENAME
