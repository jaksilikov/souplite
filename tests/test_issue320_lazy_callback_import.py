...
CALLBACK_MODULES = [
    ("souplite.utils.reward_hack_control", "RewardHackMitigationCallback"),
    ("souplite.utils.reward_hacking", "RewardHackCallback"),
    ("souplite.utils.echo_trap", "EchoTrapCallback"),
    ("souplite.utils.minillm", "MiniLLMCallback"),
    ("souplite.utils.rl_checkpoint", "RLCheckpointCallback"),
    ("souplite.utils.relora", "ReLoRACallback"),
    ("souplite.utils.lisa", "LisaCallback"),
    ("souplite.monitoring.hf_push", "HFPushCallback"),
    ("souplite.monitoring.curriculum_callback", "DynamicCurriculumCallback"),
    ("souplite.monitoring.grpo_stability_callback", "GRPOStabilityCallback"),
    ("souplite.monitoring.callback", "SoupTrainerCallback"),
]
