...
def test_fully_truncated_target_names_row_and_max_length() -> None:
    from souplite.data.sft_format import build_format_row
    from souplite.trainer.sft import _map_text_sft_rows
...
def test_position_zero_alone_is_not_a_causal_loss_target() -> None:
    from souplite.data.loss_mask import ensure_causal_loss_target
...
def test_non_finite_training_metric_is_rejected() -> None:
    from souplite.trainer.sft import _assert_finite_training_state
