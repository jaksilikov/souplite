...
from souplite.config.schema import LoraConfig
from souplite.utils.peft_builder import build_peft_config
...
class TestInstantiatePeftConfig:
    def test_instantiate_lora_config(self):
        from souplite.utils.peft_builder import instantiate_peft_config
        cfg = LoraConfig(init_strategy="pissa")
