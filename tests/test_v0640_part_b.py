...
def test_module_imports():
    from souplite.utils import terraform_plan
...
def test_training_plan_frozen():
    from souplite.utils.terraform_plan import TrainingPlan
...
def test_build_plan_happy(tmp_path, monkeypatch):
    from souplite.utils.terraform_plan import build_plan
...
def test_write_state_roundtrip(tmp_path, monkeypatch):
    from souplite.utils.terraform_plan import (
        TrainingPlan,
        TrainingState,
        read_state,
        write_state,
...
def test_write_state_outside_cwd_rejected(tmp_path, monkeypatch):
    from souplite.utils.terraform_plan import TrainingPlan, TrainingState, write_state
...
def test_detect_drift_rejects_non_state():
    from souplite.utils.terraform_plan import detect_drift
...
def test_drift_report_frozen():
    from souplite.utils.terraform_plan import DriftReport
