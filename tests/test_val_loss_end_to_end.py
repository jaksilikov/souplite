...
def _legacy_db(path, *, rows: int = 5) -> None:
    ...
    from souplite.experiment import tracker as _tracker_mod
...
class TestTheTransformersProducer:
    ...
    This is the probe @MuhtarJaksilikov used to disprove my original premise,
...
class TestItReachesTheWireNotJustTheDataclass:
    ...
    def test_val_loss_survives_to_payload(self):
        from souplite.utils.sse_train_stream import TrainEvent, to_payload
    ...
    def test_every_dataclass_field_is_serialisable(self):
        ...
        quiet drop.
        """
        from souplite.utils.sse_train_stream import _ALLOWED_KEYS, TrainEvent
...
class TestTheCallbackPushesItToTheStream:
    ...
    def test_the_pushed_event_carries_the_measured_val_loss(self, monkeypatch):
        import souplite.utils.train_event_buffer as buf
        from souplite.monitoring.callback import SoupTrainerCallback
