...
from souplite.config.schema import DataConfig, SoupConfig
...
def test_every_data_train_consumer_handles_list_non_degenerately(tmp_path, monkeypatch):
    ...
    from souplite.commands.cost import _get_dataset_size
    from souplite.commands.data import _cache_key_dataset_path
    from souplite.commands.ship import _MAX_DATA_SHA_BYTES, _compute_provenance, _safe_hash_file
    from souplite.commands.train import _lr_finder_dataset_path
    from souplite.mcp_server.registry import _collect_external_protected_inputs
    from souplite.utils.annex_xi import load_top_domains_from_jsonl
    from souplite.utils.terraform_plan import build_plan, compute_dataset_sha
