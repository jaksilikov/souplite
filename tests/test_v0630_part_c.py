...
def test_module_imports():
    from souplite.utils import active_sampler
...
def test_pick_top_uncertain_orders_descending():
    from souplite.utils.active_sampler import pick_top_uncertain
...
def test_active_learning_plan_frozen():
    from souplite.utils.active_sampler import ActiveLearningPlan
...
def test_sample_uncertain_rows_happy(tmp_path, monkeypatch):
    from souplite.utils.active_sampler import sample_uncertain_rows
