...
class TestSFTTrainerInit:
    ...
    def test_transformers_vocab_expansion_adds_tokens_and_resizes(
        ...
        monkeypatch.setattr("souplite.utils.moe.detect_moe_model", lambda _m: False)
        monkeypatch.setattr("souplite.utils.moe.get_moe_target_modules", lambda _m: [])
        monkeypatch.setattr(
            "souplite.utils.block_expansion.apply_block_expansion_if_configured",
            lambda *args, **kwargs: None,
        )
        monkeypatch.setattr(
            "souplite.utils.moe_quant.apply_moe_expert_quant_if_configured",
            lambda *args, **kwargs: None,
        )
        monkeypatch.setattr(
            "souplite.utils.peft_wiring.apply_pre_lora_patches",
            lambda *args, **kwargs: None,
        )
        monkeypatch.setattr(
            "souplite.utils.peft_wiring.apply_post_lora_patches",
            lambda *args, **kwargs: None,
        )
        monkeypatch.setattr(
