...
class TestEstimateModelMemory:
    ...
    def test_7b_4bit(self):
        from souplite.utils.profiler import estimate_model_memory
...
class TestEstimateLoraMemory:
    ...
    def test_default_lora(self):
        from souplite.utils.profiler import estimate_lora_memory
...
class TestEstimateOptimizerMemory:
    ...
    def test_adam_optimizer(self):
        from souplite.utils.profiler import estimate_optimizer_memory
...
class TestEstimateActivationMemory:
    ...
    def test_basic(self):
        from souplite.utils.profiler import estimate_activation_memory
...
class TestEstimateTotal:
    ...
    def test_basic_profile(self):
        from souplite.utils.profiler import estimate_total
...
class TestEstimateSpeed:
    ...
    def test_basic_speed(self):
        from souplite.utils.profiler import estimate_speed
...
class TestEstimateTrainingTime:
    ...
    def test_basic_time(self):
        from souplite.utils.profiler import estimate_training_time
...
class TestRecommendBatchSize:
    ...
    def test_basic_recommendation(self):
        from souplite.utils.profiler import recommend_batch_size
...
class TestRecommendGpu:
    ...
    def test_small_model(self):
        from souplite.utils.profiler import recommend_gpu
...
class TestModelArchLookup:
    ...
    def test_known_model_8b(self):
        from souplite.utils.profiler import get_model_arch
...
class TestGpuLookup:
    ...
    def test_known_gpus(self):
        from souplite.utils.profiler import GPU_MEMORY
...
class TestResolveGpuMemory:
    ...
    def test_fallback_to_default_24gb(self, monkeypatch):
        from souplite.commands.profile import _resolve_gpu_memory
...
class TestTrainableParamsEstimate:
    ...
    def test_lora_params(self):
        from souplite.utils.profiler import estimate_trainable_params
