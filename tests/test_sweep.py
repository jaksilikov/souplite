...
class TestParseSweepParams:
    ...
    def test_parse_simple_float_params(self):
        ...
        from souplite.commands.sweep import _parse_sweep_params
...
class TestParseValue:
    ...
    def test_parse_int(self):
        from souplite.commands.sweep import _parse_value
...
class TestGenerateCombinations:
    ...
    def test_grid_search(self):
        ...
        from souplite.commands.sweep import _generate_combinations
