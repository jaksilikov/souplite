...
class TestModuleSurface:
    ...
    def test_methods_exact(self):
        from souplite.utils.steering import SUPPORTED_STEERING_METHODS
    ...
    def test_metadata_mapping_proxy(self):
        ...
        from souplite.utils.steering import _STEERING_METHOD_METADATA  # type: ignore
...
class TestValidateMethod:
    def test_happy(self):
        from souplite.utils.steering import validate_steering_method
...
class TestSpec:
    def test_caa_spec(self):
        from souplite.utils.steering import get_steering_method_spec
