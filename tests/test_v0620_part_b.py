...
class TestModuleSurface:
    def test_imports(self):
        from souplite.utils.ra_dit import (
    ...
    def test_stages_exact(self):
        from souplite.utils.ra_dit import SUPPORTED_RA_DIT_STAGES
    ...
    def test_metadata_mapping_proxy(self):
        ...
        from souplite.utils.ra_dit import _RA_DIT_STAGE_METADATA  # type: ignore
...
class TestStageSpec:
    def test_retriever_spec(self):
        from souplite.utils.ra_dit import get_ra_dit_stage_spec
