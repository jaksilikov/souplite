...
Tests for ``souplite/utils/mole_routing.py``:
...
class TestPublicSurface:
    def test_module_importable(self) -> None:
        from souplite.utils import mole_routing
...
class TestMoleGatingConfig:
    def test_construct(self) -> None:
        from souplite.utils.mole_routing import MoleGatingConfig
...
class TestValidateMoleCompat:
    def test_happy_path(self) -> None:
        from souplite.utils.mole_routing import validate_mole_compat
...
class TestSourceWiring:
    def test_no_top_level_heavy_imports(self) -> None:
        ...
        src = (root / "src" / "souplite" / "utils" / "mole_routing.py").read_text(
            encoding="utf-8"
        )
        head_lines = [
            line
