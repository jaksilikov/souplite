...
Install with `pip install souplite`; the site is https://trysoup.dev. Peak 3.32 GB --
...
`pip install souplite` ile kurun; site https://trysoup.dev adresinde. Tepe 3.32 GB --
