...
def test_module_imports():
    from souplite.utils import data_score  # noqa: F401
...
def test_benchmarks_immutable():
    ...
    from souplite.utils.data_score import BENCHMARKS
...
def test_score_report_frozen():
    ...
    from souplite.utils.data_score import ScoreReport
...
def test_ngram_set_basic():
    from souplite.utils.data_score import ngram_set
...
def test_ngram_set_oversize_rejected():
    from souplite.utils.data_score import _MAX_TEXT_CHARS, ngram_set
...
def test_ngram_overlap_ratio_identical_is_one():
    from souplite.utils.data_score import ngram_overlap_ratio
...
def test_decontaminate_rows_removes_overlap():
    from souplite.utils.data_score import decontaminate_rows
...
def test_detect_pii_email():
    from souplite.utils.data_score import detect_pii
...
def test_detect_pii_caps_text_size():
    from souplite.utils.data_score import _MAX_TEXT_CHARS, detect_pii
...
def test_detect_language_english_heuristic():
    from souplite.utils.data_score import detect_language
...
def test_score_toxicity_bounds():
    from souplite.utils.data_score import score_toxicity
...
def test_score_educational_value_bounds():
    from souplite.utils.data_score import score_educational_value
...
def test_load_jsonl_rows_cap(tmp_path):
    from souplite.utils.data_score import _MAX_ROWS
