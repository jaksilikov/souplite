...
class TestVerdict:
    ...
    def test_classify(self, delta, expected):
        from souplite.eval.quant_check import classify_delta
...
class TestRunQuantCheck:
    ...
    def test_run_happy_path(self, tmp_path, monkeypatch):
        ...
        from souplite.eval.quant_check import run_quant_check
...
class TestResolveModelRef:
    def test_missing_entry_returns_none(self, tmp_path, monkeypatch):
        ...
        from souplite.eval.quant_check import resolve_model_ref
...
class TestJSONOutput:
    def test_result_serialises_to_json(self, tmp_path):
        from souplite.eval.quant_check import QuantCheckResult, QuantCheckRow
