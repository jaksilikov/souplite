...
class TestEstimateSigma:
    def test_iqr_over_1349(self):
        from souplite.utils.spectrum_scan import estimate_sigma
...
class TestMarchenkoPasturThreshold:
    def test_symmetric_in_n_m(self):
        from souplite.utils.spectrum_scan import marchenko_pastur_threshold
...
class TestComputeSnr:
    def test_signal_beats_pure_noise(self):
        from souplite.utils.spectrum_scan import compute_snr
...
class TestClassifyModule:
    ...
    def test_classification(self, name, expected):
        from souplite.utils.spectrum_scan import classify_module
...
class TestLayerTypeSignature:
    ...
    def test_strips_layer_index(self, name, sig):
        from souplite.utils.spectrum_scan import layer_type_signature
...
class TestIterWeightMatrices:
    def test_yields_only_2d_weights(self, tmp_path):
        from souplite.utils.spectrum_scan import iter_weight_matrices
...
class TestScanWeightsDir:
    def test_returns_finite_snr_per_matrix(self, tmp_path):
        from souplite.utils.spectrum_scan import scan_weights_dir
...
class TestSelectUnfrozenParameters:
    def _fake_layers(self):
        from souplite.utils.spectrum_scan import LayerSNR
    ...
    def test_top_50_percent_per_group(self):
        from souplite.utils.spectrum_scan import select_unfrozen_parameters
    ...
    def test_modules_filter(self):
        from souplite.utils.spectrum_scan import LayerSNR, select_unfrozen_parameters
...
class TestModelSlug:
    def test_sanitizes_separators(self):
        from souplite.utils.spectrum_scan import model_slug
...
class TestScanCache:
    def test_roundtrip(self, tmp_path):
        from souplite.utils.spectrum_scan import (
            ScanResult,
            read_cached_scan,
            scan_weights_dir,
            write_cached_scan,
    ...
    def test_missing_returns_none(self, tmp_path):
        from souplite.utils.spectrum_scan import read_cached_scan
...
class TestCacheDirOverride:
    def test_default_under_dot_soup(self):
        from souplite.utils.spectrum_scan import default_spectrum_cache_dir
    ...
    def test_env_override_under_cwd(self, tmp_path, monkeypatch):
        from souplite.utils import spectrum_scan
...
class TestSpectrumScanCli:
    def test_help_lists_scan(self):
        from souplite.commands import spectrum as spectrum_cmd
    ...
    def test_registered_in_main_app(self):
        from souplite.cli import app as main_app
...
class TestSpectrumScanRobustness:
    ...
    def test_symlinked_shard_skipped(self, tmp_path):
        from souplite.utils.spectrum_scan import _discover_safetensors
...
class TestParamPrefix:
    def test_strips_weight_suffix(self):
        from souplite.utils.spectrum_scan import param_prefix
