...
class TestEmbeddingSweepParams:
    ...
    def test_sweep_run_single_routes_to_embedding_trainer(self):
        ...
        with mock_patch("souplite.data.loader.load_dataset", return_value=fake_dataset), \
             ...
             mock_patch("souplite.trainer.embedding.EmbeddingTrainerWrapper.setup"), \
             mock_patch(
                 "souplite.trainer.embedding.EmbeddingTrainerWrapper.train",
...
class TestEmbeddingTrainResults:
    ...
    def test_train_result_duration_minutes_format(self):
        ...
        with mock_patch("souplite.trainer.embedding.time.time", side_effect=fake_time):
            result = wrapper.train()
...
class TestPoolingFunction:
    ...
    def test_mean_pooling(self):
        ...
        from souplite.trainer.embedding import _pool_embeddings
