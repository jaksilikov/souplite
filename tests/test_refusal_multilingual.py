...
Extends ``souplite/utils/diagnose/refusal.py::_REFUSAL_PATTERNS`` from
...
from souplite.utils.diagnose.refusal import (
    _MAX_LANG_CODE_LEN,
    _MAX_REFUSAL_SCAN,
...
class TestSourceWiring:
    ...
    def test_apply_pattern_is_module_level_function(self) -> None:
        import souplite.utils.diagnose.refusal as mod
