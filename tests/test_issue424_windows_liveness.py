...
from souplite.experiment import tracker as tracker_module
from souplite.mcp_server import execution as execution_module
...
def test_win32_never_falls_back_to_os_kill():
    ...
    try:
        time.sleep(0.2)
        with patch("souplite.utils.process_liveness.os.kill") as mock_kill:
