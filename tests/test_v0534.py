...
class TestOomFriendlyMessage:
    def test_cuda_oom_names_batch_size_and_grad_accum(self):
        ...
        with patch("souplite.utils.errors.console", test_console):
...
class TestFlashAttnV3Available:
    ...
    def test_returns_false_when_transformers_says_no(self, monkeypatch):
        from souplite.utils import flash_attn as mod
...
class TestLongLoraRejectsFlashAttnV3:
    def test_schema_rejects_longlora_when_fa3_present(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "souplite.utils.flash_attn.is_flash_attn_v3_available",
            lambda: True,
        )
        yaml_in = """
...
class TestIsQwenModel:
    def test_basic(self):
        from souplite.utils.longlora import is_qwen_model
...
class TestIsPhiModel:
    def test_basic(self):
        from souplite.utils.longlora import is_phi_model
