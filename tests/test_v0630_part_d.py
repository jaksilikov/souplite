...
def test_module_imports():
    from souplite.utils import ab_test
...
def test_validate_metric_name_happy(m):
    from souplite.utils.ab_test import validate_metric_name
...
def test_msprt_config_defaults():
    from souplite.utils.ab_test import MsprtConfig
...
def test_msprt_verdict_frozen():
    from souplite.utils.ab_test import MsprtVerdict
...
def test_run_msprt_happy(tmp_path, monkeypatch):
    from souplite.utils.ab_test import MsprtConfig, run_msprt
