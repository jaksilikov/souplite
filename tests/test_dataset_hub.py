...
class TestDataSearch:
    ...
    @patch("souplite.commands.data.list_datasets")
...
class TestDataPreview:
    ...
    @patch("souplite.commands.data._hf_dataset_info")
...
class TestDataDownload:
    ...
    @patch("souplite.commands.data._hf_download_dataset")
...
class TestHelperFunctions:
    ...
    def test_format_size_bytes(self):
        ...
        from souplite.commands.data import _format_size_bytes
    ...
    def test_format_count(self):
        ...
        from souplite.commands.data import _format_count
