...
These tests run `soup` (or `python -m souplite`) as a real subprocess,
...
# Use `python -m souplite` for reliability across platforms (no need for
# the entry-point script to be installed or on PATH).
SOUP_CMD = [sys.executable, "-m", "souplite"]
