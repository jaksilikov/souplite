...
from souplite.data.traces.pair_builder import PreferencePair
from souplite.data.traces.quality import (
    DEFAULT_MIN_CONFIDENCE,
    JudgeFilterReport,
    judge_filter_pairs,
)
from souplite.monitoring.trace_logger import (
    DEFAULT_CAP_MB,
    TraceLogWriter,
)
...
class TestFromTracesJudgeCli:
    ...
    def test_judge_flag_filters_pairs(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("souplite.eval.judge.JudgeEvaluator", FakeJudgeCls)
