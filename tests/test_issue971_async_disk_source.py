...
class TestTheDeviceGetsTheLayerItAskedFor:
    ...
    def test_no_layer_reaches_the_device_holding_another_layers_weights(
        ...
        from souplite.utils.layer_shard import layer_shard_path
        from souplite.utils.layer_stream_runtime import LayerBufferPool, StreamPrefetcher
...
class TestTheReadHappensAhead:
    ...
    def test_reads_run_on_the_reader_thread_not_the_caller(self, tmp_path, monkeypatch):
        import souplite.utils.async_disk_source as module
...
class TestTheSettingReachesTheSource:
    ...
    def test_build_source_returns_the_async_source_on_the_disk_tier(self, tmp_path):
        from souplite.utils.layer_stream_runtime import _build_source
...
class TestTheRangeWorkersSurviveDyingInBootstrap:
    ...
    def test_a_closed_pool_still_says_closed(self, monkeypatch):
        ...
        from souplite.utils.async_disk_source import _RangeReaders
