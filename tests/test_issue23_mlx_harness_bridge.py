...
def harness_run(monkeypatch, tmp_path):
    import souplite.experiment.tracker as tracker_module
    import souplite.monitoring.display as display_module
    import souplite.utils.mlx as mlx_utils
    import souplite.utils.train_event_buffer as event_buffer
