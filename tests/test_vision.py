...
class TestSFTVisionIntegration:
    ...
    def test_sft_setup_vision_calls_automodel(self):
        ...
        with patch(
            "souplite.trainer.sft.SFTTrainerWrapper._setup_vision_transformers"
        ) as mock_setup:
...
class TestDataInspectVision:
    ...
    def test_show_vision_stats_with_images(self):
        ...
        from souplite.commands.data import _show_vision_stats
        ...
        output = StringIO()
        with patch("souplite.commands.data.console", Console(file=output)):
