...
from souplite.utils.layer_shard import (  # noqa: E402
    _read_raw_tensor,
    _read_tensor,
    extras_shard_path,
    large_shard_path,
...
class TestLiveHandleBound:
    def test_sharding_keeps_at_most_the_cap_alive(self, tmp_path, monkeypatch):
        ...
        from souplite.utils.layer_shard import _MAX_LIVE_SOURCE_HANDLES
...
class TestSourceHandlesLRU:
    def test_evicts_the_least_recently_used_and_releases_the_rest_on_exit(self):
        from souplite.utils.layer_shard import _SourceHandles
