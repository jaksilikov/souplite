...
class TestNoUnicodeInOutput:
    ...
    def test_loss_format_uses_ascii(self):
        ...
        from souplite.commands.runs import _fmt_loss
    ...
    def test_fmt_float_missing_returns_ascii(self):
        ...
        from souplite.commands.runs import _fmt_float
    ...
    def test_fmt_duration_missing_returns_ascii(self):
        ...
        from souplite.commands.runs import _fmt_duration
...
class TestDiffModelLoading:
    ...
    def test_load_model_uses_torch_dtype(self):
        ...
        from souplite.commands.diff import _load_model
...
class TestCPUQuantWarning:
    ...
    def test_train_auto_disables_quant_on_cpu(self):
        ...
        from souplite.utils import gpu
        from souplite.utils.gpu import resolve_quantization
...
class TestPlotextFallback:
    ...
    def test_stats_catches_unicode_error(self):
        ...
        from souplite.commands import data
...
class TestCPUErrorMessages:
    ...
    def test_tensor_size_error_mapped(self):
        ...
        from souplite.utils.errors import ERROR_MAP
...
class TestDoctorTorchvisionCheck:
    ...
    def test_doctor_has_torchvision_check(self):
        ...
        from souplite.commands import doctor
...
class TestPPODatasetCompat:
    ...
    def test_ppo_dataset_in_constructor_flag(self):
        ...
        with mock_patch("souplite.trainer.ppo.PPOTrainerWrapper._setup_reward"), \
             mock_patch(
                 "souplite.trainer.ppo.PPOTrainerWrapper._setup_transformers"
             ), mock_patch(
                 "souplite.trainer.ppo._import_ppo_classes",
...
class TestPPOExperimentalImport:
    ...
    def test_import_ppo_classes_returns_tuple(self):
        ...
        from souplite.trainer.ppo import _import_ppo_classes
    ...
    def test_import_experimental_fallback(self):
        ...
        import souplite.trainer.ppo as ppo_mod
...
class TestPPOExperimentalSetup:
    ...
    def test_experimental_api_passes_required_args(self):
        ...
        with mock_patch("souplite.trainer.ppo.PPOTrainerWrapper._setup_reward"), \
             mock_patch("souplite.trainer.ppo.PPOTrainerWrapper._setup_transformers"), \
             mock_patch(
                 "souplite.trainer.ppo._import_ppo_classes",
                 return_value=(FakePPOTrainer, FakePPOConfig, True),
             ), \
             mock_patch(
                 "souplite.trainer.ppo.PPOTrainerWrapper._get_or_create_reward_model",
                 return_value=fake_reward_model,
             ), \
             mock_patch(
                 "souplite.trainer.ppo.PPOTrainerWrapper._create_value_model",
...
class TestGRPOCPUMinNewTokens:
    ...
    def test_cpu_adds_generation_kwargs(self):
        ...
        with mock_patch("souplite.trainer.grpo.GRPOTrainerWrapper._setup_transformers"), \
...
class TestCPUDeviceMap:
    ...
    LOADERS = [
        ("souplite.trainer.grpo", "GRPOTrainerWrapper._setup_transformers"),
        ("souplite.trainer.ppo", "PPOTrainerWrapper._setup_transformers"),
        ("souplite.trainer.ppo", "PPOTrainerWrapper._get_or_create_reward_model"),
        ("souplite.trainer.ppo", "PPOTrainerWrapper._create_value_model"),
        ("souplite.trainer.ppo", "_load_reward_model"),
        ("souplite.trainer.sft", "SFTTrainerWrapper._setup_transformers"),
        ("souplite.trainer.dpo", "DPOTrainerWrapper._setup_transformers"),
        ("souplite.trainer.reward_model", "RewardModelTrainerWrapper._setup_transformers"),
    ]
    ...
    def test_the_helper_maps_cpu_to_cpu(self):
        ...
        from souplite.utils.gpu import resolve_device_map
...
class TestPPOTokenization:
    ...
    def test_ppo_tokenization_adds_input_ids(self):
        ...
        from souplite.trainer.ppo import _prepare_ppo_dataset
