...
from souplite.utils import reward_synth as rs
...
class TestRewardSynthCli:
    ...
    def test_help(self):
        from souplite.commands.reward import app
...
class TestSelectRewardFn:
    def test_comma_split_returns_list(self):
        ...
        from souplite.trainer.grpo import _select_reward_fn
...
class TestCliRobustness:
    ...
    def test_registered_on_top_level_cli(self):
        from souplite.cli import app as root
...
class TestEnvsDocstringFix:
    def test_calculator_docstring(self):
        from souplite.envs import calculator
    ...
    def test_guess_number_docstring(self):
        from souplite.envs import guess_number
