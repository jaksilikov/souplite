...
class TestKTOSweepParams:
    ...
    def test_sweep_run_single_routes_to_kto_trainer(self):
        ...
        with mock_patch("souplite.data.loader.load_dataset", return_value=fake_dataset), \
             ...
             mock_patch("souplite.trainer.kto.KTOTrainerWrapper.setup"), \
             mock_patch(
                 "souplite.trainer.kto.KTOTrainerWrapper.train", return_value=fake_result
             ) as mock_train:
...
class TestKTOTrainResults:
    ...
    def test_train_result_duration_minutes_format(self):
        ...
        with mock_patch("souplite.trainer.kto.time.time", side_effect=fake_time):
            result = wrapper.train()
