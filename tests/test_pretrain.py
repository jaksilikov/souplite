...
class TestPlaintextDataFormat:
    ...
    def test_format_signature_exists(self):
        ...
        from souplite.data.formats import FORMAT_SIGNATURES
    ...
    def test_convert_plaintext(self):
        ...
        from souplite.data.formats import format_to_messages
...
class TestTxtFileLoading:
    ...
    def test_txt_extension_supported(self):
        ...
        from souplite.data.loader import SUPPORTED_EXTENSIONS
...
class TestPretrainSweepParams:
    ...
    def test_sweep_run_single_routes_to_pretrain_trainer(self):
        ...
        from souplite.commands.sweep import _run_single
        ...
        with mock_patch("souplite.data.loader.load_dataset", return_value=fake_dataset), \
             mock_patch("souplite.utils.gpu.detect_device", return_value=("cpu", "CPU")), \
             mock_patch("souplite.utils.gpu.get_gpu_info", return_value=fake_gpu_info), \
             mock_patch("souplite.experiment.tracker.ExperimentTracker") as mock_tracker_cls, \
             mock_patch("souplite.monitoring.display.TrainingDisplay"), \
             mock_patch("souplite.trainer.pretrain.PretrainTrainerWrapper.setup"), \
             mock_patch(
                 "souplite.trainer.pretrain.PretrainTrainerWrapper.train",
...
class TestPretrainTrainResults:
    ...
    def test_train_result_duration_minutes_format(self):
        ...
        with mock_patch("souplite.trainer.pretrain.time.time", side_effect=fake_time):
            result = wrapper.train()
...
class TestPretrainWizardPath:
    ...
    def test_wizard_pretrain_task_sets_plaintext_format(self):
        ...
        from souplite.commands.init import _interactive_wizard

        with mock_patch("souplite.commands.init.Prompt.ask", side_effect=[
            "some-model",
            "pretrain",
            "./corpus.txt",
            "1",
    ...
    def test_wizard_pretrain_does_not_prompt_for_format(self):
        ...
        with mock_patch("souplite.commands.init.Prompt.ask", side_effect=record_prompt):
            config_text = _interactive_wizard()
...
class TestPretrainMoEIntegration:
    ...
    def test_moe_lora_calls_get_moe_target_modules(self):
        ...
        with mock_patch("transformers.AutoModelForCausalLM.from_pretrained",
             ...
             mock_patch(
                 "souplite.utils.moe.detect_moe_model", return_value=True
             ), \
             mock_patch(
                 "souplite.utils.moe.get_moe_target_modules",
    ...
    def test_moe_aux_loss_coeff_sets_router_config(self):
        ...
        with mock_patch("transformers.AutoModelForCausalLM.from_pretrained",
             ...
             mock_patch("souplite.utils.moe.get_moe_target_modules",
                        return_value=None):
            from souplite.trainer.pretrain import PretrainTrainerWrapper
    ...
    def test_moe_lora_non_moe_model_skips_targets(self):
        ...
        with mock_patch("transformers.AutoModelForCausalLM.from_pretrained",
             ...
             mock_patch("peft.prepare_model_for_kbit_training"), \
             mock_patch(
                 "souplite.utils.moe.detect_moe_model", return_value=False
             ), \
             mock_patch(
                 "souplite.utils.moe.get_moe_target_modules",
                 return_value=None,
