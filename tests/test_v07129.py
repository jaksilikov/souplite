...
from souplite.utils.shrink import (
    DECISION_DONT_SHIP,
    DECISION_SHIP,
    LayerImportance,
    decide_shrink,
...
class TestNoTopLevelTorch:
    def test_shrink_module_has_no_top_level_heavy_import(self):
        import souplite.utils.shrink as _mod
...
class TestPrune:
    def test_arch_detected(self):
        from souplite.utils.shrink import shrink_arch_of
    ...
    def test_prune_removes_block_and_patches_config(self):
        from souplite.utils.shrink import prune_model_layers
    ...
    def test_layer_list_arch_guarded(self):
        from souplite.utils.shrink import layer_list
...
class TestImportance:
    def test_off_by_one_boundary_indices(self):
        ...
        from souplite.utils import shrink
    ...
    def test_select_drop_block_min(self):
        from souplite.utils.shrink import LayerImportance, select_drop_block
    ...
    def test_select_drop_block_empty_raises(self):
        from souplite.utils.shrink import select_drop_block

        with pytest.raises(ValueError):
            select_drop_block([])

    def test_resolve_drop_count_ratio(self):
        from souplite.utils.shrink import resolve_drop_count
...
class TestHeal:
    ...
    def test_heal_path_sets_healed(self, tmp_path, monkeypatch):
        ...
        from souplite.cli import app
        from souplite.commands import shrink as shrink_cmd
...
class TestRegistryAttach:
    def test_attach_round_trip(self, tmp_path, monkeypatch):
        ...
        from souplite.commands.shrink import _attach_to_registry
...
class TestReviewFixes:
    ...
    def test_perplexity_no_top_level_math_import_uses_isnan(self):
        ...
        import souplite.commands.shrink as _mod
    ...
    def test_fuse_adapter_produces_dense_model(self, tmp_path, monkeypatch):
        ...
        from souplite.commands.shrink import _fuse_adapter
...
class TestRunHeal:
    def test_success_calls_fuse_with_right_dirs(self, tmp_path, monkeypatch):
        import souplite.commands.shrink as sc
...
class TestDropCountEdges:
    ...
    def test_max_count_agrees_across_three_functions(self):
        from souplite.utils.shrink import prune_model_layers, resolve_drop_count
...
class TestArchQwen:
    def test_qwen_detected(self):
        from souplite.utils.shrink import arch_family_of_config
...
class TestExtractText:
    def test_plain_string(self):
        from souplite.commands.shrink import _extract_text
...
class TestLoadCalibEdges:
    def _run(self, tmp_path, monkeypatch, content):
        ...
        from souplite.commands.shrink import _load_calib
    ...
    def test_row_cap_truncates(self, tmp_path, monkeypatch):
        from souplite.commands import shrink as sc
...
class TestPerplexityInf:
    def test_returns_inf_when_all_single_token(self):
        ...
        from souplite.commands.shrink import _perplexity
...
class TestImportanceCaps:
    ...
    def test_mask_none_branch(self):
        from souplite.utils.shrink import compute_layer_importance
...
class TestDecideShrinkBoundaries:
    def test_just_past_tolerance_dont_ship(self):
        from souplite.utils.shrink import DECISION_DONT_SHIP, decide_shrink
    ...
    def test_match_keywords_on_validation(self):
        from souplite.utils.shrink import decide_shrink
