...
from souplite.utils import gpu as gpu_utils
...
class TestMLXDeviceDetection:
    ...
    @patch("souplite.utils.mlx.is_apple_silicon", return_value=True)
    @patch("souplite.utils.mlx.detect_mlx", return_value=True)
    @patch("souplite.utils.mlx.get_chip_info", return_value={"chip": "Apple M2 Max"})
    ...
    @patch("souplite.utils.mlx.is_apple_silicon", return_value=True)
    @patch("souplite.utils.mlx.detect_mlx", return_value=True)
    @patch("souplite.utils.mlx.get_chip_info", return_value={"chip": "Apple M3 Pro"})
    ...
    @patch("souplite.utils.mlx.detect_mlx", return_value=True)
    @patch(
        "souplite.utils.mlx.get_unified_memory_bytes", return_value=68719476736
    )  # 64 GB
    ...
    @patch("souplite.utils.mlx.is_apple_silicon", return_value=False)
