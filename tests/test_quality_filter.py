...
class TestScoreCoherenceInternal:
    ...
    def test_none_text_returns_zero(self):
        ...
        from souplite.utils.quality import _score_coherence
...
class TestFilterByQuality:
    ...
    def test_empty_data_returns_empty(self):
        ...
        from souplite.utils.quality import filter_by_quality
    ...
    def test_perplexity_filter_requires_model(self):
        ...
        with mock_patch(
            "souplite.utils.quality.compute_perplexity_scores",
            return_value=[50.0],
        ):
            kept, removed = filter_by_quality(
