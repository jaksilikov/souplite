...
class TestAnalyzeDataset:
    ...
    def test_analyze_alpaca_dataset(self, tmp_path):
        from souplite.autopilot.analyzer import analyze_dataset
...
class TestAnalyzeModel:
    def test_analyze_llama3_8b(self):
        from souplite.autopilot.analyzer import analyze_model
...
class TestAnalyzeHardware:
    def test_returns_dict_like(self):
        from souplite.autopilot.analyzer import analyze_hardware
...
class TestDecisionEngine:
    def test_decide_task_chat(self):
        from souplite.autopilot.decisions import decide_task
    ...
    def test_decide_quantization_plenty(self):
        from souplite.autopilot.decisions import decide_quantization
    ...
    def test_decide_peft_small_data(self):
        from souplite.autopilot.decisions import decide_peft
    ...
    def test_decide_performance_flags_ampere(self):
        from souplite.autopilot.decisions import decide_performance_flags
...
class TestBuildConfig:
    ...
    def test_build_soup_config(self, tmp_path):
        from souplite.autopilot.generate_config import build_soup_config
    ...
    def test_write_yaml(self, tmp_path):
        from souplite.autopilot.generate_config import build_soup_config, write_yaml
...
class TestGPUBudgetParsing:
    def test_parse_gb(self):
        from souplite.autopilot.decisions import parse_gpu_budget
