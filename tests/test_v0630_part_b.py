...
def test_module_imports():
    from souplite.utils import prune_prompt
...
def test_validate_min_frequency_happy(value):
    from souplite.utils.prune_prompt import validate_min_frequency
...
def test_prune_prompt_report_frozen():
    from souplite.utils.prune_prompt import PrunePromptReport
