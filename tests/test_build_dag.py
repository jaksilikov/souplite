"""Tests for `resolve_transform` in `souplite.utils.build_dag`.
...
class TestResolveTransformBuiltins:
    ...
    def test_identity(self):
        from souplite.utils.build_dag import BUILTIN_TRANSFORMS, resolve_transform
    ...
    def test_unknown_raises_value_error(self):
        from souplite.utils.build_dag import resolve_transform
