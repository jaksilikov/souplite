...
class TestShipConfigSchema:
    def test_defaults(self):
        from souplite.config.schema import ShipConfig
...
class TestComputeProvenance:
    def test_provenance_shape(self):
        from souplite.commands.ship import _compute_provenance
        from souplite.config.loader import load_config_from_string
...
class TestSecurityHardening:
    ...
    def test_safe_read_text_enforces_byte_cap(self):
        from souplite.commands.ship import _safe_read_text
    ...
    def test_safe_hash_file_skips_oversize(self):
        from souplite.commands.ship import _safe_hash_file
