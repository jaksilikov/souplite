...
class TestPublicSurface:
    def test_module_importable(self) -> None:
        from souplite.utils import compile_tools
...
class TestAllowlist:
    def test_frozenset(self) -> None:
        from souplite.utils.compile_tools import SUPPORTED_TOOL_OPTIMIZERS
...
class TestToolCompilePlan:
    def test_frozen(
        ...
        from souplite.utils.compile_tools import ToolCompilePlan
...
class TestRunToolCompileDeferred:
    def test_live_missing_dep_importerror(
        ...
        from souplite.utils.compile_tools import (
