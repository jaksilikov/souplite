...
_WIRED_METHODS = {
    "bco": ("souplite.trainer.bco", "BCOTrainerWrapper", "setup"),
    "dpo": ("souplite.trainer.dpo", "DPOTrainerWrapper", "setup"),
    "grpo": ("souplite.trainer.grpo", "GRPOTrainerWrapper", "setup"),
    "ipo": ("souplite.trainer.ipo", "IPOTrainerWrapper", "setup"),
    "kto": ("souplite.trainer.kto", "KTOTrainerWrapper", "setup"),
    "online_dpo": (
        "souplite.trainer.online_dpo",
        "OnlineDPOTrainerWrapper",
        "_setup_transformers",
    ),
    "orpo": ("souplite.trainer.orpo", "ORPOTrainerWrapper", "setup"),
    "ppo": ("souplite.trainer.ppo", "PPOTrainerWrapper", "setup"),
    "reward_model": (
        "souplite.trainer.reward_model",
        "RewardModelTrainerWrapper",
        "setup",
    ),
    "simpo": ("souplite.trainer.simpo", "SimPOTrainerWrapper", "setup"),
}
...
class TestEveryConversationalTrainerIsWired:
    ...
    def test_setup_applies_the_override_to_the_loaded_tokenizer(
        ...
        from souplite.utils import trust_remote
