...
class TestUDGGUF:
    def test_ud_formats_frozenset(self):
        from souplite.utils.gguf_quant import UD_GGUF_FORMATS
    ...
    def test_validate_ud_canonical_case_insensitive(self, name):
        from souplite.utils.gguf_quant import UD_GGUF_FORMATS, validate_ud_gguf_format
    ...
    def test_validate_ud_rejects(self, bad, exc):
        from souplite.utils.gguf_quant import validate_ud_gguf_format

        with pytest.raises(exc):
            validate_ud_gguf_format(bad)

    def test_is_ud_gguf_format(self):
        from souplite.utils.gguf_quant import is_ud_gguf_format
    ...
    def test_spec_frozen(self):
        from souplite.utils.gguf_quant import get_gguf_spec
    ...
    def test_calibration_data_validator(self):
        from souplite.utils.gguf_quant import validate_calibration_data_path
    ...
    def test_export_now_live(self):
        ...
        is in place.
        """
        from souplite.utils.gguf_quant import export_advanced_gguf
...
class TestIQAppleARMGGUF:
    def test_iq_frozenset(self):
        from souplite.utils.gguf_quant import IQ_GGUF_FORMATS
    ...
    def test_apple_arm_frozenset(self):
        from souplite.utils.gguf_quant import APPLE_ARM_GGUF_FORMATS
    ...
    def test_validate_iq_canonical(self, name):
        from souplite.utils.gguf_quant import validate_iq_gguf_format
    ...
    def test_validate_apple_arm_canonical(self):
        from souplite.utils.gguf_quant import validate_apple_arm_gguf_format
    ...
    def test_is_iq_and_apple_arm(self):
        from souplite.utils.gguf_quant import (
    ...
    def test_is_advanced_gguf_format(self):
        from souplite.utils.gguf_quant import is_advanced_gguf_format
...
class TestKVCache:
    def test_kv_cache_types_frozenset(self):
        from souplite.utils.kv_cache import KV_CACHE_TYPES
    ...
    def test_requires_hopper(self):
        from souplite.utils.kv_cache import requires_hopper
    ...
    def test_spec_frozen_and_metadata(self):
        from souplite.utils.kv_cache import get_kv_cache_spec
    ...
    def test_apply_live_v07114(self):
        ...
        from souplite.utils.kv_cache import KvCacheRuntime, apply_kv_cache_type
    ...
    def test_metadata_immutable(self):
        from souplite.utils.kv_cache import _KV_CACHE_METADATA
...
class TestFP8Attention:
    ...
    def test_apply_refuses_off_hopper(self, monkeypatch):
        ...
        monkeypatch.setattr("souplite.utils.fp8.is_fp8_gpu_supported", lambda: False)
...
class TestSaveFormats:
    def test_merge_save_formats_frozenset(self):
        from souplite.utils.save_formats import MERGE_SAVE_FORMATS
    ...
    def test_validate_merge_canonical(self, name):
        from souplite.utils.save_formats import validate_merge_save_format
    ...
    def test_validate_torchao_case_sensitive(self):
        from souplite.utils.save_formats import validate_torchao_scheme
    ...
    def test_quant_config_path(self):
        from souplite.utils.save_formats import validate_quant_config_path
    ...
    def test_spec_frozen(self):
        from souplite.utils.save_formats import (
            get_merge_save_spec,
            get_torchao_spec,
        )
    ...
    def test_merge_4bit_now_live(self):
        ...
        from souplite.utils.save_formats import merge_4bit
    ...
    def test_merge_4bit_bnb_kwargs_honours_double_quant(self):
        ...
        from souplite.utils.save_formats import _build_merge_4bit_bnb_kwargs
...
class TestCrossCutting:
    ...
    def test_gguf_metadata_immutable(self):
        from souplite.utils.gguf_quant import _GGUF_METADATA
...
class TestReviewFollowups:
    ...
    def test_lower_index_immutable(self):
        from souplite.utils.gguf_quant import _LOWER_INDEX
    ...
    def test_requires_hopper_reads_from_spec(self):
        ...
        from souplite.utils.kv_cache import (
            _KV_CACHE_METADATA,
            requires_hopper,
        )
