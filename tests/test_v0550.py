...
class TestSourceGrep:
    ...
    def test_eval_py_registers_v0550_module(self):
        text = (self.REPO_ROOT / "src" / "souplite" / "commands" / "eval.py").read_text(
            encoding="utf-8",
        )
    ...
    def test_v0550_module_uses_lazy_imports(self):
        ...
        text = (self.REPO_ROOT / "src" / "souplite" / "commands" / "_eval_v0550.py").read_text(
            encoding="utf-8",
        )
    ...
    def test_version_bumped_to_0_55_0(self):
        ...
        init_text = (
            self.REPO_ROOT / "src" / "souplite" / "__init__.py"
