...
class TestDataInspect:
    ...
    def test_inspect_jsonl(self, tmp_path):
        ...
        client = TestClient(create_app())
        with patch("souplite.ui.app.Path.cwd", return_value=tmp_path):
            response = client.post(
                "/api/data/inspect",
...
class TestTrainEndpoints:
    ...
    def test_train_status_not_running(self):
        ...
        import souplite.ui.app as ui_app_module
        from souplite.ui.app import create_app
    ...
    def test_start_training(self, tmp_path):
        ...
        with patch("souplite.ui.app.subprocess.Popen", return_value=mock_popen):
            client = TestClient(create_app())
            response = client.post(
                "/api/train/start",
                json={
...
class TestStaticFiles:
    ...
    def test_static_dir_exists(self):
        ...
        from souplite.ui.app import STATIC_DIR
