...
class TestResolveFrozenBaseLoadDtype:
    def test_cpu_resolves_to_auto(self):
        from souplite.utils.gpu import resolve_frozen_base_load_dtype
...
WRAPPER_CASES = [
    ("souplite.trainer.dpo", "DPOTrainerWrapper", "AutoModelForCausalLM", _base_kwargs("dpo")),
    ("souplite.trainer.kto", "KTOTrainerWrapper", "AutoModelForCausalLM", _base_kwargs("kto")),
    ("souplite.trainer.orpo", "ORPOTrainerWrapper", "AutoModelForCausalLM", _base_kwargs("orpo")),
    (
    ...
    ("souplite.trainer.ipo", "IPOTrainerWrapper", "AutoModelForCausalLM", _base_kwargs("ipo")),
    ("souplite.trainer.bco", "BCOTrainerWrapper", "AutoModelForCausalLM", _base_kwargs("bco")),
    (
    ...
    ("souplite.trainer.grpo", "GRPOTrainerWrapper", "AutoModelForCausalLM", _base_kwargs("grpo")),
    ("souplite.trainer.ppo", "PPOTrainerWrapper", "AutoModelForCausalLM", _base_kwargs("ppo")),
    (
...
class TestRewardModelHeadUpcastToFp32:
    ...
    def test_score_head_is_fp32_even_when_base_resolves_to_bf16(self):
        ...
        with patch(
            "souplite.trainer.reward_model.resolve_frozen_base_load_dtype",
