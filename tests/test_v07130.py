...
from souplite.utils.prm_reward import (
    AGGREGATE_MODES,
...
class TestLoadRewardHeadWeights:
    def test_loads_head_from_safetensors(self, tmp_path):
        ...
        from souplite.utils.prm_reward import load_reward_head_weights
...
def _make_fake_scorer(aggregate="min"):
    ...
    from souplite.utils.prm_reward import PRMScorer
...
class TestBuildPrmRewardFn:
    def test_returns_named_scorer(self, monkeypatch):
        import souplite.utils.prm_reward as mod
...
class TestResolveTrust:
    def test_delegates_with_requires_flag(self, monkeypatch):
        import souplite.utils.trust_remote as trust_mod
        from souplite.utils.prm_reward import _resolve_trust
...
class TestEnvs:
    ...
    def test_rows_normalise(self, modname):
        ...
        mod = importlib.import_module(f"souplite.envs.{modname}")
        rows = mod.rollout([])
    ...
    def test_calculator_answers_correct(self):
        ...
        from souplite.envs.calculator import rollout
    ...
    def test_guess_number_answer_matches_product(self):
        ...
        from souplite.envs.guess_number import rollout
    ...
    def test_retrieval_qa_answer_matches_asked_fact(self):
        ...
        from souplite.envs.retrieval_qa import rollout
    ...
    def test_row_count_is_default(self, modname):
        ...
        from souplite.envs._common import DEFAULT_ROWS
    ...
    def test_envs_produce_distinct_output(self):
        ...
        from souplite.envs import calculator, guess_number, retrieval_qa
...
class TestGrpoPrmWiring:
    def test_prm_reward_selected(self, monkeypatch):
        import souplite.trainer.grpo as grpo

        sentinel = object()
        monkeypatch.setattr(
            "souplite.utils.prm_reward.build_prm_reward_fn",
    ...
    def test_standard_reward_selected(self, monkeypatch):
        ...
        monkeypatch.setattr("souplite.trainer.rewards.load_reward_fn", _fake_load)
...
class TestRecipes:
    ...
    def test_recipe_yaml_parses(self, name):
        ...
        assert cfg.training.rollout_func.startswith("souplite.envs.")
...
class TestBuildPrmTrainResult:
    def test_has_all_summary_keys(self):
        from souplite.trainer.prm import build_prm_train_result
