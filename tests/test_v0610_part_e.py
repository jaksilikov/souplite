...
class TestDataclasses:
    def test_imports(self):
        from souplite.utils.edit_diff import (
            DiffReport,
            FactChange,
            build_diff_report,
            load_probes,
    ...
    def test_fact_change_frozen(self):
        from souplite.utils.edit_diff import FactChange
    ...
    def test_diff_report_frozen(self):
        from souplite.utils.edit_diff import DiffReport, FactChange
    ...
    def test_diff_report_validates_changes_tuple(self):
        from souplite.utils.edit_diff import DiffReport
...
class TestLoadProbes:
    ...
    def test_happy_path(self, tmp_path):
        from souplite.utils.edit_diff import load_probes
...
class TestRenderDiffTable:
    ...
    def test_non_report_rejected(self):
        ...
        from souplite.utils.edit_diff import render_diff_table
...
class TestWriteDiffReport:
    ...
    def test_non_report_rejected(self, tmp_path):
        from souplite.utils.edit_diff import write_diff_report
