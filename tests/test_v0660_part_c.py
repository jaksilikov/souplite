...
def test_bundled_probes_immutable():
    ...
    from souplite.utils.sleeper_probe import BUNDLED_PROBES
...
def test_defection_verdicts_closed():
    from souplite.utils.sleeper_probe import DEFECTION_VERDICTS
...
def test_validate_base_happy():
    from souplite.utils.sleeper_probe import BUNDLED_PROBES, validate_base_for_probe
...
def test_validate_base_unknown_raises():
    from souplite.utils.sleeper_probe import validate_base_for_probe
...
def test_apply_sleeper_probe_returns_per_token_scores():
    from souplite.utils.sleeper_probe import apply_sleeper_probe
...
def test_run_sleeper_probe_hidden_dim_mismatch():
    from souplite.utils.sleeper_probe import BUNDLED_PROBES, run_sleeper_probe
...
def test_render_sleeper_json_roundtrip():
    from souplite.utils.sleeper_probe import SleeperProbeResult, render_sleeper_json
...
def test_render_sleeper_json_rejects_non_result():
    from souplite.utils.sleeper_probe import render_sleeper_json
...
def test_render_sleeper_markdown_has_verdict():
    from souplite.utils.sleeper_probe import SleeperProbeResult, render_sleeper_markdown
...
def test_render_sleeper_markdown_rejects_non_result():
    from souplite.utils.sleeper_probe import render_sleeper_markdown
