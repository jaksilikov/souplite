...
from souplite.utils.adapter_merge import (
...
def test_supported_strategies_immutable():
    ...
    from souplite.utils.adapter_merge import STRATEGY_ORDER
...
def test_no_top_level_torch_import_in_merge():
    src = (Path(__file__).parent.parent / "src" / "souplite" / "utils" / "adapter_merge.py"
