...
from souplite.utils.profiler import GPU_MEMORY, normalize_gpu_key
...
def no_gpu(monkeypatch):
    ...
    monkeypatch.setattr("souplite.utils.gpu.get_gpu_info", _no_device)
...
def wide_console(monkeypatch):
    ...
    monkeypatch.setattr("souplite.commands.profile.console", Console(width=200))
...
def mcp_config(tmp_path, monkeypatch):
    ...
    (tmp_path / "soup.yaml").write_text(_MCP_CONFIG, encoding="utf-8")
    return "soup.yaml"
