...
class TestRLCheckpointPublicSurface:
    def test_module_imports(self):
        from souplite.utils import rl_checkpoint
...
class TestValidateSaveEverySteps:
    def test_happy(self):
        from souplite.utils.rl_checkpoint import validate_save_every_steps
...
class TestRLCheckpointConfig:
    def test_defaults(self):
        from souplite.utils.rl_checkpoint import RLCheckpointConfig
...
class TestRLCheckpointState:
    ...
    def test_basic(self):
        from souplite.utils.rl_checkpoint import RLCheckpointState
