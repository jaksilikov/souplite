...
def test_module_imports():
    from souplite.utils import hardware_fit
...
def test_safety_margin_is_10pct():
    from souplite.utils.hardware_fit import VRAM_SAFETY_MARGIN
...
def test_validate_seq_len_happy(v):
    from souplite.utils.hardware_fit import validate_seq_len
...
def test_validate_batch_size_happy(v):
    from souplite.utils.hardware_fit import validate_batch_size
...
def test_vram_breakdown_frozen():
    from souplite.utils.hardware_fit import VRAMBreakdown
...
def test_estimate_peak_vram_returns_breakdown():
    from souplite.utils.hardware_fit import HardwareFitInput, VRAMBreakdown, estimate_peak_vram_gb
...
def test_estimate_peak_vram_4bit_smaller_than_fp16():
    from souplite.utils.hardware_fit import HardwareFitInput, estimate_peak_vram_gb
...
def test_estimate_peak_vram_rejects_non_input():
    from souplite.utils.hardware_fit import estimate_peak_vram_gb
...
def test_hardware_fit_report_frozen():
    from souplite.utils.hardware_fit import HardwareFitReport, VRAMBreakdown
...
def test_no_heavy_top_level_imports():
    ...
    src = Path(__file__).resolve().parent.parent / "src" / "souplite" / "utils" / "hardware_fit.py"
