...
class TestValidateLambdaLabs:
    ...
    def test_lambda_validate_cloud(self):
        from souplite.cloud.lambda_labs import validate_cloud
    ...
    def test_lambda_validate_gpu(self):
        from souplite.cloud.lambda_labs import validate_gpu
...
class TestRenderLambdaLabsStub:
    def test_render_happy_path(self):
        from souplite.cloud.lambda_labs import render_lambda_stub
        ...
        assert "souplite[train]==0.71.22" in payload["user_data"]
...
class TestSubmitLambdaLabsRun:
    def test_override_seam(self, monkeypatch):
        import souplite.cloud.lambda_labs as m
        from souplite.cloud._common import CloudPlan
