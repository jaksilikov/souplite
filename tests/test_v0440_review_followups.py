...
from souplite.commands.llama import _LLAMA_ENV_ALLOWLIST, _filtered_env
from souplite.ui.plugins import (
    clear_tabs,
    list_tabs,
    load_plugins,
    register_tab,
)
from souplite.utils.checkpoint_trigger import write_trigger
from souplite.utils.delinearize_llama4 import discover_weight_files
from souplite.utils.fetch_examples import fetch_examples_dir
from souplite.utils.fsdp_consolidate import discover_shards, plan_consolidation
from souplite.utils.gpu_monitor import (
    detect_apple_silicon,
    query_nvidia_smi,
)
from souplite.utils.llama_proxy import resolve
from souplite.utils.llama_server_timings import format_kv_bar, parse_timings
from souplite.utils.onboarding import render_onboarding_yaml
from souplite.utils.qr_url import build_phone_url, render_qr_ascii, validate_token
from souplite.utils.shortcuts import (
    build_macos_command_file,
    build_windows_cmd,
)
from souplite.utils.sweep_config import parse_sweep_yaml
from souplite.utils.tail_latency import percentile, summarise_latency, update_ema
from souplite.utils.tool_outputs import ToolCallTimer, ToolOutputsBuffer
from souplite.utils.ui_env import resolve_ui_env
...
def test_tool_outputs_ring_drops_oldest_after_overflow():
    ...
    from souplite.utils.tool_outputs import _MAX_RECORDS
...
def test_graceful_save_restore_idempotent(monkeypatch):
    ...
    from souplite.utils.graceful_save import GracefulSaveHandler
