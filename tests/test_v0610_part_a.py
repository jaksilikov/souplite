...
class TestModuleSurface:
    def test_imports(self):
        from souplite.utils.unlearning import (
    ...
    def test_supported_methods_exact(self):
        from souplite.utils.unlearning import SUPPORTED_UNLEARN_METHODS
    ...
    def test_metadata_mapping_proxy(self):
        ...
        from souplite.utils.unlearning import _UNLEARN_METHOD_METADATA  # type: ignore
...
class TestGetUnlearnMethodSpec:
    def test_happy_path(self):
        from souplite.utils.unlearning import get_unlearn_method_spec
...
class TestBuildUnlearnTrainer:
    ...
    def test_returns_wrapper_instance(self):
        ...
        from souplite.utils.unlearning import build_unlearn_trainer
...
class TestSourceWiring:
    def test_cli_registers_edit_typer(self):
        ...
        cli_src = Path(__file__).resolve().parent.parent / "src" / "souplite" / "cli.py"
