...
class TestSpectralKernels:
    def test_imports(self):
        from souplite.utils.adapter_scan import (
            ScanFinding,
            ScanReport,
    ...
    def test_compute_spectral_features_uniform_matrix_no_dominance(self):
        from souplite.utils.adapter_scan import compute_spectral_features
...
class TestScanAdapterWeights:
    def test_clean_weights_pass(self):
        from souplite.utils.adapter_scan import scan_adapter_weights
    ...
    def test_scan_finding_frozen(self):
        from souplite.utils.adapter_scan import ScanFinding
    ...
    def test_kind_in_allowlist(self):
        from souplite.utils.adapter_scan import _VALID_KINDS
...
class TestSourceWiring:
    def test_module_imports_clean(self):
        import souplite.utils.adapter_scan as m
    ...
    def test_no_top_level_torch(self):
        src = (
            ...
            / "src" / "souplite" / "utils" / "adapter_scan.py"
        )
