...
# Patch targets — lazy imports in deploy.py resolve to souplite.utils.ollama
_OLLAMA = "souplite.utils.ollama"
...
def test_export_deploy_unsupported_target():
    ...
    from souplite.commands.export import _auto_deploy_ollama
