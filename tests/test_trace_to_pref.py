...
class TestLangChainParser:
    def test_parse_event_with_thumbs_up(self):
        from souplite.data.traces.parsers import parse_langchain
...
class TestOpenAIParser:
    def test_parse_completion_with_feedback(self):
        from souplite.data.traces.parsers import parse_openai
...
class TestPairBuilder:
    def test_build_pairs_from_thumbs(self):
        ...
        from souplite.data.traces.parsers import Trace
...
class TestLiterals:
    def test_format_literal_accepts_known(self):
        from souplite.data.traces.pair_builder import SUPPORTED_SIGNALS
    ...
    def test_parser_registry(self):
        from souplite.data.traces.parsers import SUPPORTED_FORMATS
