...
from souplite.eval.custom import (
    MAX_EVAL_TASKS,
    MAX_REGEX_INPUT_LEN,
...
class TestRunEval:
    def test_run_eval_with_mock_generator(self):
        from souplite.eval.custom import run_eval
...
class TestEvalConfig:
    def test_eval_config_default(self):
        from souplite.config.schema import EvalConfig
        config = EvalConfig()
...
class TestCallbackAutoEval:
    ...
    def test_auto_eval_called_when_enabled(self):
        ...
        with patch("souplite.commands.eval.benchmark") as mock_bench:
