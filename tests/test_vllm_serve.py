...
class TestVllmDetection:
    ...
    def test_get_vllm_version_installed(self):
        ...
        from souplite.utils.vllm import get_vllm_version
...
class TestServeBackendFlag:
    ...
    def test_vllm_backend_not_installed(self, tmp_path):
        ...
        with patch("souplite.utils.vllm.is_vllm_available", return_value=False):
            result = runner.invoke(
    ...
    def test_vllm_hint_shown_when_available(self, tmp_path):
        ...
        from souplite.commands import serve as serve_mod
        ...
        try:
            with patch("souplite.utils.vllm.is_vllm_available", return_value=True):
