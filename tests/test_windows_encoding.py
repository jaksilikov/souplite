...
from souplite.utils import encoding as enc
...
def test_cli_bootstrap_calls_force_utf8(monkeypatch):
    """souplite.cli imports `force_utf8_stdio` so it runs at module load."""
...
def test_writers_use_utf8_encoding():
    ...
    audited_files = [
        "src/souplite/commands/quickstart.py",
        "src/souplite/commands/init.py",
        "src/souplite/commands/migrate.py",
    ]
