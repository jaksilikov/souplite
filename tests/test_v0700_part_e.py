...
class TestIterativeDPOPublicSurface:
    def test_module_imports(self):
        from souplite.utils import iterative_dpo
...
class TestValidateRounds:
    def test_happy(self):
        from souplite.utils.iterative_dpo import validate_rounds
...
class TestValidatePairsPerRound:
    def test_happy(self):
        from souplite.utils.iterative_dpo import validate_pairs_per_round
...
class TestIterativeDPORound:
    def test_basic(self):
        from souplite.utils.iterative_dpo import IterativeDPORound
...
class TestIterativeDPOPlan:
    ...
    def test_zero_rounds_rejected(self):
        from souplite.utils.iterative_dpo import IterativeDPOPlan
...
class TestBuildIterativeDPOPlan:
    def test_happy(self, tmp_path, monkeypatch):
        from souplite.utils.iterative_dpo import build_iterative_dpo_plan
