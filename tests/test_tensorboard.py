...
class TestTensorBoardSweepRouting:
    ...
    def test_sweep_run_single_with_tensorboard_report_to(self):
        ...
        with mock_patch("souplite.data.loader.load_dataset", return_value=fake_dataset), \
             ...
             mock_patch("souplite.trainer.sft.SFTTrainerWrapper.setup"), \
             mock_patch(
                 "souplite.trainer.sft.SFTTrainerWrapper.train", return_value=fake_result
             ):
