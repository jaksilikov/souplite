...
def test_module_imports():
    from souplite.utils import license_advisor
...
def test_deploy_targets_exact():
    from souplite.utils.license_advisor import DEPLOY_TARGETS
...
def test_validate_deploy_target_happy(v):
    from souplite.utils.license_advisor import validate_deploy_target
...
def test_license_recommendation_frozen():
    from souplite.utils.license_advisor import LicenseRecommendation
...
def test_advise_license_b2c():
    from souplite.utils.license_advisor import advise_license_for_target
...
def test_downstream_risk_frozen():
    from souplite.utils.license_advisor import DownstreamRisk
...
def test_no_heavy_top_level_imports():
    ...
    src = (
        ...
        / "src" / "souplite" / "utils" / "license_advisor.py"
    )
