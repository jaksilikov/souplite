...
_WRAPPERS = {
    "bco": ("souplite.trainer.bco", "BCOTrainerWrapper", "BCOConfig"),
    "dpo": ("souplite.trainer.dpo", "DPOTrainerWrapper", "DPOConfig"),
    "ipo": ("souplite.trainer.ipo", "IPOTrainerWrapper", "DPOConfig"),
    "kto": ("souplite.trainer.kto", "KTOTrainerWrapper", "KTOConfig"),
    "orpo": ("souplite.trainer.orpo", "ORPOTrainerWrapper", "ORPOConfig"),
    "simpo": ("souplite.trainer.simpo", "SimPOTrainerWrapper", "CPOConfig"),
}
...
class TestTheCanaryCoversWhatItClaims:
    ...
    def test_every_wrapper_that_passes_max_prompt_length_is_listed(self):
        ...
        trainer_dir = pathlib.Path(__file__).resolve().parents[1] / "src" / "souplite" / "trainer"
