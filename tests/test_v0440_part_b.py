...
from souplite.utils.checkpoint_trigger import (
    TRIGGER_FILENAME,
    consume_trigger,
    should_save_now,
    trigger_path,
...
from souplite.utils.onboarding import (
    VALID_QUANT,
    VALID_TASKS,
...
def test_build_linux_desktop_entry():
    spec = build_linux_desktop_entry(name="SoupLite", command="soup ui")
    assert spec.platform == "linux"
    assert spec.filename == "souplite.desktop"
