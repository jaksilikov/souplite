...
class TestToolCallingTemplate:
    def test_build_prompt_contains_domains_and_count(self):
        from souplite.data.templates.tool_calling import build_prompt
    ...
    def test_available_domains(self):
        from souplite.data.templates.tool_calling import TEMPLATE_SPEC
...
class TestToolCallScoring:
    ...
    def test_tool_call_match_exact(self):
        from souplite.eval.custom import tool_call_match
    ...
    def test_tool_call_args_subset_partial(self):
        from souplite.eval.custom import tool_call_args_subset
    ...
    def test_tool_call_scoring_registered(self):
        ...
        from souplite.eval.custom import VALID_SCORING
