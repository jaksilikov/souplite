...
def test_init_template_help_lists_all_templates():
    from souplite.commands.init import _template_help_string
    from souplite.templates import list_templates
...
def test_migrate_sniff_does_not_read_a_whole_unnewlined_file(tmp_path: Path):
    ...
    from souplite.commands.migrate import _looks_like_jsonl
...
def test_history_dataset_registry_helper_handles_missing():
    from souplite.commands.history import _name_exists_in_dataset_registry
