...
class TestNormBlowupPolicy:
    def test_defaults(self):
        from souplite.utils.edit_governor import NormBlowupPolicy
...
class TestClassifyNormBlowup:
    def test_ok_band(self):
        from souplite.utils.edit_governor import classify_norm_blowup
...
class TestGovernorRecommendMethod:
    def test_no_switch_below_threshold(self):
        from souplite.utils.edit_governor import governor_recommend_method
