...
def test_module_imports():
    from souplite.utils import interference
...
def test_verdicts_closed():
    from souplite.utils.interference import INTERFERENCE_VERDICTS
...
def test_compute_interference_zero_when_identical_loss():
    from souplite.utils.interference import compute_interference
...
def test_build_matrix_2x2():
    from souplite.utils.interference import build_interference_matrix
...
def test_render_matrix_json_rejects_non_matrix():
    from souplite.utils.interference import render_matrix_json
...
def test_render_matrix_markdown_empty_cells():
    from souplite.utils.interference import InterferenceMatrix, render_matrix_markdown
...
def test_render_matrix_markdown_rejects_non_matrix():
    from souplite.utils.interference import render_matrix_markdown
