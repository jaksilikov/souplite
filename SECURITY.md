...
running the most recent version from PyPI (`pip install -U souplite`).
...
- Preferred: open a private report via
  [GitHub Security Advisories](https://github.com/MuhtarJaksilikov/Soup/security/advisories/new).
...
> [GitHub Releases](https://github.com/MuhtarJaksilikov/Soup/releases) notes.
