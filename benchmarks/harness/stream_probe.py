...
def install_sync_source_control() -> str:
    ...
    from souplite.utils.layer_stream_runtime import DiskSource
...
def build(args: argparse.Namespace, device: str, dtype: str) -> Tuple[Any, ...]:
    from souplite.utils.layer_shard import resolve_shard_dir, shard_checkpoint
...
class Instruments:
    ...
    def _install_pool(self) -> None:
        ...
        from souplite.utils.layer_stream_runtime import _release_source
...
def gpu_facts(device: str) -> Dict[str, Any]:
    ...
    facts: Dict[str, Any] = {
        ...
        "souplite_file": souplite.__file__,
    }
...
def run_steps(
    ...
    *,
    ...
    from souplite.utils.layer_stream_runtime import sm_clock_mhz
...
def measure_ceiling(device: str, dtype: str, shapes: Dict[str, Any], tokens: int) -> Dict[str, Any]:
    ...
    from souplite.utils.layer_stream_runtime import measure_gemm_tflops, sm_clock_mhz
