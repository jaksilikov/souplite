...
Filed against [#23](https://github.com/MuhtarJaksilikov/Soup/issues/23), which
...
- **8 GB**, against the 128 GiB M4 Max of that record and the M4 of
  [#362](https://github.com/MuhtarJaksilikov/Soup/pull/362). A footprint problem
...
[#363](https://github.com/MuhtarJaksilikov/Soup/issues/363) was `backend: mlx`
...
spill in [#649](https://github.com/MuhtarJaksilikov/Soup/issues/649) — "the step
...
- **`target_modules: auto` means Q/V only here.** Every run printed
  ...
  [#392](https://github.com/MuhtarJaksilikov/Soup/issues/392), where shipping
...
1. **A bare HTTP 401 from the Hub proves nothing.** I initially read 401 as
   ...
   [#661](https://github.com/MuhtarJaksilikov/Soup/issues/661) on evidence rather
...
3. **The tok/s column mixed two different measurements.** Row 1 quoted `~240`,
   ...
   @MuhtarJaksilikov, who noticed rows 1 and 3 share a tokenizer and identical
