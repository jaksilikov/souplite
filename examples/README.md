...
soup init --template audio       # audio/speech — needs pip install "souplite[audio]"
soup train
```
...
[`config/schema.py`](../src/souplite/config/schema.py) is the single source of truth.
...
- [GitHub Discussions](https://github.com/MuhtarJaksilikov/Soup/discussions)
- [Issues](https://github.com/MuhtarJaksilikov/Soup/issues)
